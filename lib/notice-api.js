...
NotesManagement.prototype.add_tag = function(tag_name){
    if (!this.storage_manager.put(this.table_tags,{value:tag_name})) {
        this.notice_error("error while adding tag");
    };
};

NotesManagement.prototype.remove_tag = function(tag_name){
    if (!this.storage_manager.delete(this.table_tags,{value:tag_name})) {
        this.notice_error("error while removing tag");
    };
};

NotesManagement.prototype.get_tags = function(){
